		...
		<div class="menu-block customscroll">
			<div class="sidebar-menu">
				<ul id="accordion-menu">
					...
					<li class="dropdown">
						<a href="javascript:;" class="dropdown-toggle">
							<span class="fa fa-dashboard"></span><span class="mtext">MFS-Dashboard</span>
						</a>
						<ul class="submenu">
							<li><a href="index.php">Normal Traffic</a></li>
							<li><a href="index_notraffic.php">No Traffic</a></li>
							<li><a href="incoming_traffic.php">Incoming Trafic</a></li>
					...
					<li class="dropdown">
						<a href="javascript:;" class="dropdown-toggle">
							<span class="fa fa-google-wallet"></span><span class="mtext">DW</span>
						</a>
						<ul class="submenu">
							<li><a href="disbursement_accounts.php">DW Accounts</a></li>
							<li><a href="disbursement.php">DW Balances</a></li>
							<li><a href="disbursement_recipients.php">DW Recipients</a></li>
						</ul>
					</li>
					
					<li class="dropdown">
						<a href="javascript:;" class="dropdown-toggle">
							<span class="fa fa-bar-chart"></span><span class="mtext">MFS-Trends</span>
						</a>
						<ul class="submenu">
							<li><a href="trend_normal.php">Normal Trends</a></li>
							<li><a href="trend_leading.php">Leading Trends</a></li>
							<li><a href="#trend_spot.php">Spot Trends</a></li>
						</ul>
					</li>
					...
					<li>
						<a href="#index.php" class="dropdown-toggle no-arrow">
							<span class="fa fa-file"></span><span class="mtext">MFS-Reports</span>
						</a>
					</li>
					<li>
						<a href="tps_chart.php" class="dropdown-toggle no-arrow">
							<span class="fa fa-line-chart"></span><span class="mtext">MFS-TPS</span>
						</a>
					</li>
					<li class="dropdown">
						<a href="javascript:;" class="dropdown-toggle">
							<span class="fa fa-table"></span><span class="mtext">MFS-Architectures</span>
						</a>
						<ul class="submenu">
							<li><a href="archtect_slide.php">Architectures Slide</a></li>
							<li><a href="#archtect_Specific.php">Architectures Specific</a></li>
							
						</ul>
					</li>
					<li class="dropdown">
						<a href="javascript:;" class="dropdown-toggle">
							<span class="fa fa-sitemap"></span><span class="mtext">MFS-Nodes Radar</span>
						</a>
						<ul class="submenu">
							<li><a href="#">Interem Server</a></li>
							<li><a href="#">E-Statement</a></li>
							<li><a href="#">TigoPesa App</a></li>
							<li><a href="#">Access Gateway</a></li>
							<li><a href="#">Payment Gateway</a></li>
							<li><a href="#">Middleware</a></li>
							<li><a href="#">Nano Credit</a></li>
							<li><a href="#">M4000 DB</a></li>
							<li><a href="#">Tigo Bima</a></li>
						</ul>
					</li>
					<!--
					<li class="dropdown">
