	...
	<div class="header clearfix">
		<div class="header-right">
			<div class="brand-logo">
				<a href="index.php">
					<img src="vendors/images/deskapp-logo.jpg" alt="" class="mobile-logo">
				</a>
			</div>
			<div class="menu-icon">
			...
			<div class="user-info-dropdown">
				...
				<div class="dropdown">
					...
					<a class="dropdown-toggle" href="#" role="button" data-toggle="dropdown">
						...
						<span class="user-name">ITSM CC </span>
					</a>
			...
			<div style="width:100%;" class="user-notification">
			<center><h2>Tigopesa TPS Chart as of <?php echo $dateLeo; ?> (Tps Vs Time ) </h2></center>
